...
function ImageDialog(props: any): JSX.Element {
    ...
    const [urlValue, setUrlValue] = useState<string>(selectedCoupon?.image);
        ...
        <div className="ImageDialog">
            <Dialog open={open} onClose={handleClose} aria-labelledby="alert-dialog-title" aria-describedby="alert-dialog-description">
                ...
                <DialogContent>
                    ...
                    <TextField label="Url" fullWidth defaultValue={selectedCoupon?.image} onChange={((e) => setUrlValue(e.target.value))} /><br /><br />
                </DialogContent>
                <DialogActions>
