...
public class AuthService {
    ...
    /**
     * Authenticates admin credentials with the hard-coded ones.
     * @param loginData
     * @return
    ...
    /**
     * Authenticates company credentials with those stored at the database.
     * @param loginData
     * @return
     * @throws AuthenticationException
    ...
    /**
     * Authenticates customer credentials with those stored at the database.
     * @param loginData
     * @return
     * @throws AuthenticationException
    ...
    /**
     * Authenticates a client based on his id and type, upon login success returns token, otherwise exception.
     * @param loginData
     * @param clientId
     * @param clientType
     * @return
